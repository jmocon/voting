...
<html class="no-js css-menubar" lang="en">
	<head>
		...
		<meta name="description" content="<?php echo $clsContent->GetName(); ?> - Member">
		<meta name="author" content="">

		<title>Dashboard | <?php echo $clsContent->GetName(); ?> - Member</title>
							...
							<a href="AddVote.php?Id=<?php echo $mdlElection->getId(); ?>" style="text-decoration:none;" class="grey-700">
								<div class="card-block p-30">
									<div class="row">
										...
										<div class="col-6 vertical-align text-center">
											<span class="gray-700 font-size-70 vertical-align-middle">
