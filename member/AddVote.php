...
<head>
	...
	<title>Edit Profile |
		<?php echo $clsContent->GetName(); ?> - Member</title>
						...
						<div class="panel">
							...
							<div class="panel-heading">
								<h3 class="panel-title">
									<?php echo $clsElection->GetNameById($electionId); ?>
								</h3>
							</div>

							<?php
							if ($clsVote->IsVoted($userId,$electionId)) {
								$msg = '
								<div class="alert alert-success alert-dismissible" role="alert">
								<button type="button" class="close" data-dismiss="alert" aria-label="Close">
								<span aria-hidden="true">×</span>
							...
							<div class="panel-body">
								<div class="row">
									<div class="form-group col-md-12">
										<label class="form-control-label" for="inputCandidatePositionName">
											<?php echo $mdlCP->getName(); ?> <small>(Select maximum of
												<?php echo $mdlCP->getMaxVote(); ?> candidate)</small></label>
										<div class="row ">
