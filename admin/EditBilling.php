...
if(isset($_GET['Id']) && $_GET['Id'] != ""){
	$mdlBilling = $clsBilling->GetById($_GET['Id']);
}else{
...
if(isset($_POST['Name'])){
	...
	$err .= $clsFn->setForm('Description',$mdlBilling,true);
	...
	if($err == ""){
		...
		if($duplicate['val']){
			...
			<h4>Successfully Updated Billing. </h4>
			</div>';
		}
	}else{
		$msg .= '
...
<html class="no-js css-menubar" lang="en">
	<head>
		...
		<title>Edit Billing | <?php echo $clsContent->GetName(); ?> - Admin</title>
