...
if(isset($_POST['Name'])){
	...
	$err .= $clsFn->setForm('Name',$mdlBilling,true);
	$err .= $clsFn->setForm('Description',$mdlBilling);

	if($err == ""){
		$duplicate = $clsBilling->IsExist($mdlBilling);
		if($duplicate['val']){
			$err = $duplicate['msg'];
			$msg .= '
			...
			$billingId = $clsBilling->Add($mdlBilling);
			$msg .= '
			...
			<h4>Successfully Added New Billing. </h4>
			</div>';
...
<html class="no-js css-menubar" lang="en">
	<head>
		...
		<meta name="viewport" content="width=device-width, initial-scale=1.0, billing-scalable=0, minimal-ui">
		<meta name="description" content="<?php echo $clsContent->GetName(); ?> - Admin">
		<meta name="author" content="">

		<title>Add New Billing | <?php echo $clsContent->GetName(); ?> - Admin</title>
	...
	<body class="animsition">
		...
		<div class="page">
			<div class="page-header">
				<h1 class="page-title">Add New Billing</h1>
				<ol class="breadcrumb">
					<li class="breadcrumb-item"><a href="ViewBilling.php">Billings</a></li>
								...
								<div class="panel-body">
									<div class="row">
										<div class="form-group col-md-12">
											<label class="form-control-label" for="inputName">Billing Name</label>
											<div class="row">
												<div class="col-lg-12">
													<input type="text" class="form-control" id="inputName" name="Name" placeholder="Name" value="<?php echo $mdlBilling->getName(); ?>" >
									...
									<div class="row">
										<div class="form-group col-md-12">
											<label class="form-control-label" for="inputDescription">Billing Description</label>
											<div class="row">
												<div class="col-lg-12">
													<textarea class="form-control" id="inputDescription" name="Description" placeholder="Description"> <?php echo $mdlBilling->getDescription(); ?> </textarea>
													<small id="notif-inputName" class="invalid-feedback">This is required</small>
												</div>
											</div>
										</div>
		...
		<script>
			$('#submit').click(function(){
				var err = 0;
				if(!checkSelect('inputBillingType_Id')){
					err++;
				}
				if(!checkInput('inputBillingname')){
					err++;
				}
