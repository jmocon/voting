...
if(isset($_POST['FirstName'])){
	...
	if($err == ""){
		...
		if($duplicate['val']){
			...
			<h4>Successfully Added New User. </h4>
			</div>';
			$imgResult = $clsUser->SetImage($_FILES["fileToUpload"],$userId);
			if($imgResult['msg'] != ""){
				$msg .= '
				<div class="alert alert-danger alert-dismissible" role="alert">
				<button type="button" class="close" data-dismiss="alert" aria-label="Close">
...
<html class="no-js css-menubar" lang="en">
	<head>
		...
		<title>Add New User | <?php echo $clsContent->GetName(); ?> - Admin</title>
								...
								<div class="panel-body">
									...
									<div class="row mb-2">
										<div class="col-12">
											...
											<input type="file" id="inputImage" data-plugin="dropify" data-default-file="" accept="image/*" name="fileToUpload"/>
