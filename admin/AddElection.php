...
if(isset($_POST['Name'])){
	...
	$err .= $clsFn->setForm('Name',$mdlElection,true);
	$err .= $clsFn->setForm('Description',$mdlElection);


	if($err == ""){
		$duplicate = $clsElection->IsExist($mdlElection);
		if($duplicate['val']){
			$err = $duplicate['msg'];
			$msg .= '
			...
			$electionId = $clsElection->Add($mdlElection);
			$msg .= '
			...
			<h4>Successfully Added New Election. </h4>
			</div>';
...
<html class="no-js css-menubar" lang="en">
	<head>
		...
		<meta name="viewport" content="width=device-width, initial-scale=1.0, election-scalable=0, minimal-ui">
		<meta name="description" content="<?php echo $clsContent->GetName(); ?> - Admin">
		<meta name="author" content="">

		<title>Add New Election | <?php echo $clsContent->GetName(); ?> - Admin</title>
	...
	<body class="animsition">
		...
		<div class="page">
			<div class="page-header">
				<h1 class="page-title">Add New Election</h1>
				<ol class="breadcrumb">
					<li class="breadcrumb-item"><a href="ViewElection.php">Elections</a></li>
						...
						<div class="col-12">
							<div class="panel">
								<div class="panel-heading">
									<h3 class="panel-title">Election Details</h3>
								</div>
								<?php echo $msg; ?>
								<div class="panel-body">
									<div class="row">
										<div class="form-group col-md-12">
											<label class="form-control-label" for="inputName">Election Name</label>
											<div class="row">
												<div class="col-lg-12">
													<input type="text" class="form-control" id="inputName" name="Name" placeholder="Name" value="<?php echo $mdlElection->getName(); ?>" >
									...
									<div class="row">
										<div class="form-group col-md-12">
											<label class="form-control-label" for="inputDescription">Election Description</label>
											<div class="row">
												<div class="col-lg-12">
													<textarea class="form-control" id="inputDescription" name="Description" placeholder="Description"> <?php echo $mdlElection->getDescription(); ?> </textarea>
													<small id="notif-inputName" class="invalid-feedback">This is required</small>
												</div>
											</div>
										</div>
		...
		<script>
			$('#submit').click(function(){
				var err = 0;
				if(!checkSelect('inputElectionType_Id')){
					err++;
				}
				if(!checkInput('inputElectionname')){
					err++;
				}
