	...
	<body class="animsition">
		...
		<div class="page">
			<div class="page-header">
				...
				<ol class="breadcrumb">
					<li class="breadcrumb-item"><a href="ViewVote.php">Vote</a></li>
					<li class="breadcrumb-item active">Add New Vote</li>
				</ol>
			</div>
								...
								<div class="panel-body">
									<div class="row">
										<div class="form-group col-md-6">
												<label class="form-control-label" for="inputUser">Voter Name</label>
												<select class="form-control" id="inputUser_Id" name="User_Id" data-plugin="select2" data-placeholder="Select Name">
													...
													<optgroup label="User">
														...
														foreach($lstU as $mdlU){
															if($mdlU->getId() == $mdlVote->getUser_Id()){
											...
											<div class="row">
												<div class="form-group col-md-6">
														<label class="form-control-label" for="inputPosition">Candidate Name</label>
														<select class="form-control" id="inputPosition_Id" name="Candidate_Id" data-plugin="select2" data-placeholder="Select a Candidate">
															<option></option>
															<optgroup label="Candidate name">
																<?php
																$lstCandidate = $clsCandidate->Get();
																foreach($lstCandidate as $mdlCandidate){
																	if($mdlCandidate->getId() == $mdlVote->getCandidate_Id()){
																		echo '<option value="'.$mdlCandidate->getId().'" selected>'.$clsUser->GetNameById($mdlCandidate->getUser_Id())." - ".$clsCandidatePosition->GetNameById($mdlCandidate->getCandidatePosition_Id()).'</option>';
																	}else{
																		echo '<option value="'.$mdlCandidate->getId().'">'.$clsUser->GetNameById($mdlCandidate->getUser_Id())." - ".$clsCandidatePosition->GetNameById($mdlCandidate->getCandidatePosition_Id()).'</option>';
																	}
																}
																?>
															</optgroup>
											...
											<div class="row">
												<div class="form-group col-md-6">
														...
														<select class="form-control" id="inputElection_Id" name="Election_Id" data-plugin="select2" data-placeholder="Select an Election">
															<option></option>
															<optgroup label="Election">
																<?php
																$lstE = $clsElection->Get();
																foreach($lstE as $mdlE){
																	if($mdlE->getId() == $mdlVote->getElection_Id()){
