...
<html class="no-js css-menubar" lang="en">
	<head>
		...
		<title>Candidate List | <?php echo $clsContent->GetName(); ?> - Admin</title>
	...
	<body class="animsition">
		...
		<div class="page">
			<div class="page-header">
				<h1 class="page-title">View Candidates</h1>
				<ol class="breadcrumb">
								...
								<div class="panel-body">
									<table class="table table-hover dataTable table-striped w-full" data-plugin="dataTable">
										...
										<tbody>
											...
											{
											?>
											<tr id="trMessage<?php echo $mdlCandidate->getId(); ?>">
												<td><?php echo $clsUser->GetNameById($mdlCandidate->getUser_Id()); ?></td>
												<td><?php echo $clsCandidatePosition->GetNameById($mdlCandidate->getCandidatePosition_Id()); ?></td>
												<td><?php echo $clsElection->GetNameById($mdlCandidate->getElection_Id()); ?></td>
												<td>
													<span data-toggle="modal" data-target="#ModalWrapper" onclick="displayCandidate(<?php echo $mdlCandidate->getId(); ?>);">
													...
													<a href="EditCandidate.php?Id=<?php echo $mdlCandidate->getId(); ?>" class="btn btn-sm btn-icon btn-pure btn-default" data-toggle="tooltip" data-original-title="Edit">
														<i class="icon wb-edit" aria-hidden="true"></i>
													</a>

													<span data-toggle="modal" data-target="#ModalWrapper" onclick="deleteShowCandidate(<?php echo $mdlCandidate->getId(); ?>);">
