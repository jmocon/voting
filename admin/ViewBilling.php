...
<html class="no-js css-menubar" lang="en">
	<head>
		...
		<title>Billing | <?php echo $clsContent->GetName(); ?> - Member</title>
	...
	<body class="animsition">
		...
		<div class="page">
			<div class="page-header">
				<h1 class="page-title">View Billing</h1>
				<ol class="breadcrumb">
							...
							<div class="panel">
								...
								<div class="panel-body">
									<table class="table table-hover dataTable table-striped w-full" data-plugin="dataTable">
										...
										<tbody>
											<?php
											$lstBilling = $clsBilling->Get();
											foreach($lstBilling as $mdlBilling)
											{
											?>
											<tr id="trMessage<?php echo $mdlBilling->getId(); ?>">
												<td><?php echo $mdlBilling->getName(); ?></td>
												<td>
													<span data-toggle="modal" data-target="#ModalWrapper" onclick="displayBilling(<?php echo $mdlBilling->getId(); ?>);">
													...
													<a href="EditBilling.php?Id=<?php echo $mdlBilling->getId(); ?>" class="btn btn-sm btn-icon btn-pure btn-default" data-toggle="tooltip" data-original-title="Edit">
														<i class="icon wb-edit" aria-hidden="true"></i>
													</a>

													<span data-toggle="modal" data-target="#ModalWrapper" onclick="deleteShowBilling(<?php echo $mdlBilling->getId(); ?>);">
