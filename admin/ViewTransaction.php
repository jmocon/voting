...
<html class="no-js css-menubar" lang="en">
	<head>
		...
		<title>Transaction List | <?php echo $clsContent->GetName(); ?> - Admin</title>
							...
							<div class="panel">
								...
								<div class="panel-body">
									<table class="table table-hover dataTable table-striped w-full" data-plugin="dataTable">
										...
										<tbody>
											<?php
											$lstTransaction = $clsTransaction->Get();
											foreach($lstTransaction as $mdlTransaction)
											{
											?>
											<tr id="trMessage<?php echo $mdlTransaction->getId(); ?>">
												<td><?php echo $clsBilling->GetNameById($mdlTransaction->getBilling_Id()); ?></td>
												<td><?php echo $clsUser->GetNameById($mdlTransaction->getUser_Id()); ?></td>
												<td><?php echo date_format(date_create($mdlTransaction->getsqlDatePaid()),"F j, Y"); ?></td>
												<td>
													<span data-toggle="modal" data-target="#ModalWrapper" onclick="displayTransaction(<?php echo $mdlTransaction->getId(); ?>);">
													...
													<a href="EditTransaction.php?Id=<?php echo $mdlTransaction->getId(); ?>" class="btn btn-sm btn-icon btn-pure btn-default" data-toggle="tooltip" data-original-title="Edit">
														<i class="icon wb-edit" aria-hidden="true"></i>
													</a>

													<span data-toggle="modal" data-target="#ModalWrapper" onclick="deleteShowTransaction(<?php echo $mdlTransaction->getId(); ?>);">
