...
<html class="no-js css-menubar" lang="en">
	<head>
		...
		<title>CandidatePosition | <?php echo $clsContent->GetName(); ?> - Member</title>
		...
		function displayCandidatePosition(id) {
      ...
      modal.classList.add("modal-primary");
			...
			url = "../Ajax/ViewCandidatePosition.php";
			url += "?call=display";
			url += "&Id=" + id;
		...
		function deleteCandidatePosition(id) {
			...
			url = "../Ajax/ViewCandidatePosition.php";
			url += "?call=deleteCandidatePosition";
			url += "&Id=" + id;
			xmlhttp.open("GET", url, true);
			xmlhttp.send();
	...
	<body class="animsition">
		...
		<div class="page">
			<div class="page-header">
				<h1 class="page-title">View Candidate Position</h1>
				<ol class="breadcrumb">
					<li class="breadcrumb-item"><a href="../index.php">Dashboard</a></li>
					<li class="breadcrumb-item active">View Candidate Position</li>
				</ol>
			</div>
							...
							<div class="panel">
								...
								<div class="panel-body">
									<table class="table table-hover dataTable table-striped w-full" data-plugin="dataTable">
										...
										<tbody>
											<?php
											$lstCandidatePosition = $clsCandidatePosition->Get();
											foreach($lstCandidatePosition as $mdlCandidatePosition)
											{
											?>
											<tr id="trMessage<?php echo $mdlCandidatePosition->getId(); ?>">
												<td><?php echo $mdlCandidatePosition->getName(); ?></td>
												<td>
													<span data-toggle="modal" data-target="#ModalWrapper" onclick="displayCandidatePosition(<?php echo $mdlCandidatePosition->getId(); ?>);">
