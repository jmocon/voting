...
if(isset($_GET['Id']) && $_GET['Id'] != ""){
	$mdlElection = $clsElection->GetById($_GET['Id']);
}else{
...
if(isset($_POST['Name'])){
	...
	$err .= $clsFn->setForm('Description',$mdlElection,true);
	...
	if($err == ""){
		...
		if($duplicate['val']){
			...
			$clsElection->Update($mdlElection);
			$msg .= '
			...
			<h4>Successfully Updated Election. </h4>
			</div>';
		}
	}else{
		$msg .= '
...
<html class="no-js css-menubar" lang="en">
	<head>
		...
		<title>Edit Election | <?php echo $clsContent->GetName(); ?> - Admin</title>
