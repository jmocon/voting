										...
										<tbody>
											...
											<tr id="trMessage<?php echo $mdlElection->getId(); ?>">
												...
												<td>
													...
													<a href="EditElection.php?Id=<?php echo $mdlElection->getId(); ?>" class="btn btn-sm btn-icon btn-pure btn-default" data-toggle="tooltip" data-original-title="Edit">
														<i class="icon wb-edit" aria-hidden="true"></i>
													</a>

													<span data-toggle="modal" data-target="#ModalWrapper" onclick="deleteShowElection(<?php echo $mdlElection->getId(); ?>);">
