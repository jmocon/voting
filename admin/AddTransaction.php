...
if(isset($_POST['User_Id'])){
	...
	if($err == ""){
		if($clsTransaction->IsExist($mdlTransaction)){
			...
			$transactionId = $clsTransaction->Add($mdlTransaction);
			$msg .= '
			...
			<h4>Successfully Added New Transaction. </h4>
			</div>';
...
<html class="no-js css-menubar" lang="en">
	<head>
		...
		<title>Add New Transaction | <?php echo $clsContent->GetName(); ?> - Admin</title>
	...
	<body class="animsition">
		...
		<div class="page">
			<div class="page-header">
				<h1 class="page-title">Add New Transaction</h1>
				<ol class="breadcrumb">
