...
function displayVote($voteId)
{
  ...
  <div class="modal-body">
		...
		<div class="row">
			...
			<div class="col-md-8">
				<?php echo $clsUser->getNameById($clsCandidate->getUser_IdById($mdlVote->getCandidate_Id()))," - ",$clsCandidatePosition->getNameById($clsCandidate->getCandidatePosition_IdById($mdlVote->getCandidate_Id())); ?>
			</div>
		</div>
		<div class="row">
			<div class="col-md-4">
