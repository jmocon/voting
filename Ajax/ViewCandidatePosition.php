...
function addFeature($id)
{
	...
	<div class="modal-header">
		...
		<h3 class="modal-title">Featured Candidate Position</h3>
	</div>
	<div class="modal-body">
		<h4 class="card-title">Candidate Position Added to Featured</h4>
	</div>
...
function removeFeature($id)
{
	...
	<div class="modal-body">
		<h4 class="card-title">Candidate Position Removed from Featured</h4>
	</div>
	<div class="modal-footer">
		<button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
	</div>
...
function displayCandidatePosition($candidatepositionId)
{
	...
	<div class="modal-header">
		...
		<h3 class="modal-title">Candidate Position Detail</h3>
	</div>
	<div class="modal-body">

		<div class="row">
			<div class="col-md-12">
				<h4>Candidate Position Details</h4>
			</div>
		</div>
		...
		<div class="row">
			...
			<div class="col-md-8">
				<?php echo $purifier->purify($mdlCandidatePosition->getMaxVote()); ?>
			</div>
		</div>
	</div>
	<div class="modal-footer">
...
function deleteShow($id)
{
	...
	<div class="modal-body">
		...
		<div class="row">
			...
			<div class="col-md-8">
				<?php echo $mdlCandidatePosition->getMaxVote(); ?>
			</div>
		</div>
	</div>
	<div class="modal-footer">
